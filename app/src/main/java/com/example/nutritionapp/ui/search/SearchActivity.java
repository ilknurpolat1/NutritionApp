...
public class SearchActivity extends AppCompatActivity {
    ...
    String key = "G+X01BPs0GJtjGCKDaBREA==gJnktDaWe4H4v7em";
    String title;
    ...
    public interface JsonPlaceHolderApi {
        @GET("nutrition")
        Call<JsonObject> getNutritionInfo(@Query("query") String query, @Header("X-Api-Key") String apiKey);
    }

    public void searchValue(String content, Float serving) {

        Retrofit retrofit = new Retrofit.Builder().baseUrl("https://api.calorieninjas.com/v1/").addConverterFactory(GsonConverterFactory.create()).build();
        JsonPlaceHolderApi jsonPlaceHolderApi = retrofit.create(JsonPlaceHolderApi.class);
        Call<JsonObject> call = jsonPlaceHolderApi.getNutritionInfo(content, key);
